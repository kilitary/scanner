...
struct SExecConnectedEventParams {
  int EventRetVal;
  int StatusCode;
  char* Description;
  int reserved;
...
struct SExecConnectionStatusEventParams {
  int EventRetVal;
...
struct SExecDisconnectedEventParams {
  int EventRetVal;
  int StatusCode;
  char* Description;
  int reserved;
...
struct SExecSSHCustomAuthEventParams {
  int EventRetVal;
  char* Packet;
  int reserved;
};

struct SExecSSHKeyboardInteractiveEventParams {
  int EventRetVal;
  char* Name;
  char* Instructions;
  char* Prompt;
...
struct SExecSSHServerAuthenticationEventParams {
  int EventRetVal;
  char* HostKey;
  char* Fingerprint;
  char* KeyAlgorithm;
...
struct SExecSSHStatusEventParams {
  int EventRetVal;
  char* Message;
  int reserved;
};

struct SExecStderrEventParams {
  int EventRetVal;
  char* Text;
  int lenText;
  int reserved;
...
class SExec : public QObject {

  Q_OBJECT
signals: //events

    void Connected(SExecConnectedEventParams *e);
    void ConnectionStatus(SExecConnectionStatusEventParams *e);
    void Disconnected(SExecDisconnectedEventParams *e);
    void Error(SExecErrorEventParams *e);
    void SSHCustomAuth(SExecSSHCustomAuthEventParams *e);
    void SSHKeyboardInteractive(SExecSSHKeyboardInteractiveEventParams *e);
    void SSHServerAuthentication(SExecSSHServerAuthenticationEventParams *e);
    void SSHStatus(SExecSSHStatusEventParams *e);
    void Stderr(SExecStderrEventParams *e);
    void Stdout(SExecStdoutEventParams *e);
...
protected: // event firers
  ...
  protected:
    ...
    static int IPWORKSSSH_CALL SExecEventSink(void *lpObj, int event_id, int cparam, void *param[], int cbparam[]) {
      ...
      switch (event_id) {
         case 1: {
            SExecConnectedEventParams e = {0, (int)IPH64CAST(param[0]), (char*)IPH64CAST(param[1]),  0};
            ret_code = ((SExec*)lpObj)->FireConnected(&e);
            break;
         }
         case 2: {
            SExecConnectionStatusEventParams e = {0, (char*)IPH64CAST(param[0]), (int)IPH64CAST(param[1]), (char*)IPH64CAST(param[2]),  0};
            ret_code = ((SExec*)lpObj)->FireConnectionStatus(&e);
            break;
         }
         case 3: {
            SExecDisconnectedEventParams e = {0, (int)IPH64CAST(param[0]), (char*)IPH64CAST(param[1]),  0};
            ret_code = ((SExec*)lpObj)->FireDisconnected(&e);
            break;
         }
         case 4: {
            SExecErrorEventParams e = {0, (int)IPH64CAST(param[0]), (char*)IPH64CAST(param[1]),  0};
            ret_code = ((SExec*)lpObj)->FireError(&e);
            break;
         }
         case 5: {
            SExecSSHCustomAuthEventParams e = {0, (char*)IPH64CAST(param[0]),  0};
            ret_code = ((SExec*)lpObj)->FireSSHCustomAuth(&e);
            param[0] = (void*)(e.Packet);
            break;
         }
         case 6: {
            SExecSSHKeyboardInteractiveEventParams e = {0, (char*)IPH64CAST(param[0]), (char*)IPH64CAST(param[1]), (char*)IPH64CAST(param[2]), (char*)IPH64CAST(param[3]), (int)IPH64CAST(param[4]),  0};
            ret_code = ((SExec*)lpObj)->FireSSHKeyboardInteractive(&e);
            param[3] = (void*)(e.Response);
            break;
         }
         case 7: {
            SExecSSHServerAuthenticationEventParams e = {0, (char*)IPH64CAST(param[0]), (char*)IPH64CAST(param[1]), (char*)IPH64CAST(param[2]), (int)IPH64CAST(param[3]), (int)IPH64CAST(cbparam[0]),  0};
            ret_code = ((SExec*)lpObj)->FireSSHServerAuthentication(&e);
            param[3] = (void*)(e.Accept);
            break;
         }
         case 8: {
            SExecSSHStatusEventParams e = {0, (char*)IPH64CAST(param[0]),  0};
            ret_code = ((SExec*)lpObj)->FireSSHStatus(&e);
            break;
         }
         case 9: {
            SExecStderrEventParams e = {0, (char*)IPH64CAST(param[0]), (int)IPH64CAST(cbparam[0]),  0};
            ret_code = ((SExec*)lpObj)->FireStderr(&e);
            break;
         }
         case 10: {
            SExecStdoutEventParams e = {0, (char*)IPH64CAST(param[0]), (int)IPH64CAST(cbparam[0]),  0};
  ...
  public: //properties
    ...
    inline int SetCommand(const QString &Command) {
      ...
      #endif
      return IPWorksSSH_SExec_Set(m_pObj, 1, 0, (void*)qba.data(), 0);
    }
    ...
    inline int SetFirewallHost(const QString &FirewallHost) {
      ...
      #endif
      return IPWorksSSH_SExec_Set(m_pObj, 7, 0, (void*)qba.data(), 0);
    }
    ...
    inline int SetFirewallPassword(const QString &FirewallPassword) {
      ...
      #endif
      return IPWorksSSH_SExec_Set(m_pObj, 8, 0, (void*)qba.data(), 0);
    }
    ...
    inline int SetFirewallUser(const QString &FirewallUser) {
      ...
      #endif
      return IPWorksSSH_SExec_Set(m_pObj, 10, 0, (void*)qba.data(), 0);
    }
    ...
    inline int SetLocalHost(const QString &LocalHost) {
      ...
      #endif
      return IPWorksSSH_SExec_Set(m_pObj, 11, 0, (void*)qba.data(), 0);
    }
    ...
    inline int SetSSHAcceptServerHostKeyEncoded(const QByteArray &qba) {
      return IPWorksSSH_SExec_Set(m_pObj, 13, 0, (void*)qba.data(), qba.size());
    }
    ...
    inline int SetSSHCertEncoded(const QByteArray &qba) {
      return IPWorksSSH_SExec_Set(m_pObj, 15, 0, (void*)qba.data(), qba.size());
    }
    ...
    inline int SetSSHCertStore(const QByteArray &qba) {
      return IPWorksSSH_SExec_Set(m_pObj, 16, 0, (void*)qba.data(), qba.size());
    }
    ...
    inline int SetSSHCertStorePassword(const QString &SSHCertStorePassword) {
      ...
      #endif
      return IPWorksSSH_SExec_Set(m_pObj, 17, 0, (void*)qba.data(), 0);
    }
    ...
    inline int SetSSHCertSubject(const QString &SSHCertSubject) {
      ...
      #endif
      return IPWorksSSH_SExec_Set(m_pObj, 19, 0, (void*)qba.data(), 0);
    }
    ...
    inline int SetSSHCompressionAlgorithms(const QString &SSHCompressionAlgorithms) {
      ...
      #endif
      return IPWorksSSH_SExec_Set(m_pObj, 20, 0, (void*)qba.data(), 0);
    }
    ...
    inline int SetSSHEncryptionAlgorithms(const QString &SSHEncryptionAlgorithms) {
      ...
      #endif
      return IPWorksSSH_SExec_Set(m_pObj, 21, 0, (void*)qba.data(), 0);
    }
    ...
    inline int SetSSHHost(const QString &SSHHost) {
      ...
      #endif
      return IPWorksSSH_SExec_Set(m_pObj, 22, 0, (void*)qba.data(), 0);
    }
    ...
    inline int SetSSHPassword(const QString &SSHPassword) {
      ...
      #endif
      return IPWorksSSH_SExec_Set(m_pObj, 23, 0, (void*)qba.data(), 0);
    }
    ...
    inline int SetSSHUser(const QString &SSHUser) {
      ...
      #endif
      return IPWorksSSH_SExec_Set(m_pObj, 25, 0, (void*)qba.data(), 0);
    }


    inline int SetStdin(const QByteArray &qba) {
      return IPWorksSSH_SExec_Set(m_pObj, 26, 0, (void*)qba.data(), qba.size());
    }
